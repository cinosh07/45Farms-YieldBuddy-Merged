...
<?php
session_start();
include 'sql/sql_lighting_firstrow.php';
include 'sql/sql_watering_firstrow.php';
...
<table width="850" border="0" align="center">
  <tr>
    <td height="100" align="center" valign="middle"><h6><br />      
    <img src="img/banner.png" alt="" width="280" height="52" />[v1.16]</h6></td>
  </tr>
  <tr>
...
<table width="775" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="191">&nbsp;</td>
    <td width="584" align="right" valign="bottom">&nbsp;</td>
</tr>
<tr>
