...
var int=self.setInterval(function(){loop()},1000);
function loop() {
...
function updateRelayInfo() {
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			if(ajaxRequest.responseText != PastResponseText_Relays){
				document.getElementById("relayInfo").innerHTML = ajaxRequest.responseText;
				PastResponseText_Relays = ajaxRequest.responseText;
			}
		}
	}
...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="100" colspan="2" align="center" valign="bottom"><h6><br />
  ...
  <tr>
    ...
    <?php 
	include 'sql/sql_camera_firstrow.php';
	session_start();
