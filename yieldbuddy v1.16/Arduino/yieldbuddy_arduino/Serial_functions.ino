...
void sendserialmessages(){
  ...
  if (serialcounter == 1 || serialcounter == 4){
    //SEND TIMESTAMP
    updatelongdate();
    Serial1.print("Time,");
    ...
    Serial1.print(",");
    Serial1.print(TDS1_char[0]);
    Serial1.print(TDS1_char[1]);
    Serial1.print(TDS1_char[2]);
    Serial1.print(TDS1_char[3]);
    Serial1.print(TDS1_char[4]);
    Serial1.print(TDS1_char[5]);
    Serial1.print(",");
    Serial1.print(TDS2_char[0]);
    Serial1.print(TDS2_char[1]);
    Serial1.print(TDS2_char[2]);
    Serial1.print(TDS2_char[3]);
    Serial1.print(TDS2_char[4]);
    Serial1.print(TDS2_char[5]);
    Serial1.print(",");
    Serial1.print(CO2_char[0]);
    Serial1.print(CO2_char[1]);
    Serial1.print(CO2_char[2]);
    Serial1.print(CO2_char[3]);
    Serial1.print(CO2_char[4]);
    Serial1.print(",");
