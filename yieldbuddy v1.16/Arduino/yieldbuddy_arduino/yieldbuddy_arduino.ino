...
int Relay1_Pin = 52;  //Water Pump 1
int Relay2_Pin = 50;  //Water Pump 2
int Relay3_Pin = 48;  //Free
int Relay4_Pin = 46;  //Free
int Relay5_Pin = 44;  //Free
int Relay6_Pin = 42;  //Light/Ballast
