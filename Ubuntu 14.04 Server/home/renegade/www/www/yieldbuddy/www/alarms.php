...
<table width="1060" align="center">
    <td height="258" align="left" valign="top"><div class="cssbox"><p>
      ...
      <table width="850" border="0" align="center">
		...
		if ($_SESSION['WaterTempP1_Low_Alarm'] > 0) {
			echo "<tr>";
				echo "<td>";
				echo $_SESSION['WaterTempP1_Low_Time'];
				echo "</td>";
				echo "<td>WaterTempP1 Low</td>";
				if ($_SESSION['WaterTempP1_Low_Alarm'] == 1) {
					echo "<td>Unacknowledged</td>";
					echo "<td></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP1','Low_Alarm',3)\" /></td>";
				}
				if ($_SESSION['WaterTempP1_Low_Alarm'] == 2) {
					echo "<td>Unacknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP1','Low_Alarm',4)\" /></td>";
				}
				if ($_SESSION['WaterTempP1_Low_Alarm'] == 3) {
					echo "<td>Acknowledged</td>";
					echo "<td></td>";
					echo "<td></td>";
				}
				if ($_SESSION['WaterTempP1_Low_Alarm'] == 4) {
					echo "<td>Acknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td></td>";
				}
				echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Delete\" onclick=\"alarm_sql('WaterTempP1','Low_Alarm',0)\" /></td>";
			echo "</tr>";
		}
		
		if ($_SESSION['WaterTempP1_High_Alarm'] > 0) {
			echo "<tr>";
				echo "<td>";
				echo $_SESSION['WaterTempP1_High_Time'];
				echo "</td>";
				echo "<td>WaterTempP1 High</td>";
				if ($_SESSION['WaterTempP1_High_Alarm'] == 1) {
					echo "<td>Unacknowledged</td>";
					echo "<td></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP1','High_Alarm',3)\" /></td>";
				}
				if ($_SESSION['WaterTempP1_High_Alarm'] == 2) {
					echo "<td>Unacknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP1','High_Alarm',4)\" /></td>";
				}
				if ($_SESSION['WaterTempP1_High_Alarm'] == 3) {
					echo "<td>Acknowledged</td>";
					echo "<td></td>";
					echo "<td></td>";
				}
				if ($_SESSION['WaterTempP1_High_Alarm'] == 4) {
					echo "<td>Acknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td></td>";
				}
				echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Delete\" onclick=\"alarm_sql('WaterTempP1','High_Alarm',0)\" /></td>";
			echo "</tr>";
		}

		if ($_SESSION['WaterTempP2_Low_Alarm'] > 0) {
			echo "<tr>";
				echo "<td>";
				echo $_SESSION['WaterTempP2_Low_Time'];
				echo "</td>";
				echo "<td>WaterTempP2 Low</td>";
				if ($_SESSION['WaterTempP2_Low_Alarm'] == 1) {
					echo "<td>Unacknowledged</td>";
					echo "<td></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP2','Low_Alarm',3)\" /></td>";
				}
				if ($_SESSION['WaterTempP2_Low_Alarm'] == 2) {
					echo "<td>Unacknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP2','Low_Alarm',4)\" /></td>";
				}
				if ($_SESSION['WaterTempP2_Low_Alarm'] == 3) {
					echo "<td>Acknowledged</td>";
					echo "<td></td>";
					echo "<td></td>";
				}
				if ($_SESSION['WaterTempP2_Low_Alarm'] == 4) {
					echo "<td>Acknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td></td>";
				}
				echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Delete\" onclick=\"alarm_sql('WaterTempP2','Low_Alarm',0)\" /></td>";
			echo "</tr>";
		}
		
		if ($_SESSION['WaterTempP2_High_Alarm'] > 0) {
			echo "<tr>";
				echo "<td>";
				echo $_SESSION['WaterTempP2_High_Time'];
				echo "</td>";
				echo "<td>WaterTempP2 High</td>";
				if ($_SESSION['WaterTempP2_High_Alarm'] == 1) {
					echo "<td>Unacknowledged</td>";
					echo "<td></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP2','High_Alarm',3)\" /></td>";
				}
				if ($_SESSION['WaterTempP2_High_Alarm'] == 2) {
					echo "<td>Unacknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP2','High_Alarm',4)\" /></td>";
				}
				if ($_SESSION['WaterTempP2_High_Alarm'] == 3) {
					echo "<td>Acknowledged</td>";
					echo "<td></td>";
					echo "<td></td>";
				}
				if ($_SESSION['WaterTempP2_High_Alarm'] == 4) {
					echo "<td>Acknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td></td>";
				}
				echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Delete\" onclick=\"alarm_sql('WaterTempP2','High_Alarm',0)\" /></td>";
			echo "</tr>";
		}

		if ($_SESSION['WaterTempP3_Low_Alarm'] > 0) {
			echo "<tr>";
				echo "<td>";
				echo $_SESSION['WaterTempP3_Low_Time'];
				echo "</td>";
				echo "<td>WaterTempP3 Low</td>";
				if ($_SESSION['WaterTempP3_Low_Alarm'] == 1) {
					echo "<td>Unacknowledged</td>";
					echo "<td></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP3','Low_Alarm',3)\" /></td>";
				}
				if ($_SESSION['WaterTempP3_Low_Alarm'] == 2) {
					echo "<td>Unacknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP3','Low_Alarm',4)\" /></td>";
				}
				if ($_SESSION['WaterTempP3_Low_Alarm'] == 3) {
					echo "<td>Acknowledged</td>";
					echo "<td></td>";
					echo "<td></td>";
				}
				if ($_SESSION['WaterTempP3_Low_Alarm'] == 4) {
					echo "<td>Acknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td></td>";
				}
				echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Delete\" onclick=\"alarm_sql('WaterTempP3','Low_Alarm',0)\" /></td>";
			echo "</tr>";
		}
		
		if ($_SESSION['WaterTempP3_High_Alarm'] > 0) {
			echo "<tr>";
				echo "<td>";
				echo $_SESSION['WaterTempP3_High_Time'];
				echo "</td>";
				echo "<td>WaterTempP3 High</td>";
				if ($_SESSION['WaterTempP3_High_Alarm'] == 1) {
					echo "<td>Unacknowledged</td>";
					echo "<td></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP3','High_Alarm',3)\" /></td>";
				}
				if ($_SESSION['WaterTempP3_High_Alarm'] == 2) {
					echo "<td>Unacknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP3','High_Alarm',4)\" /></td>";
				}
				if ($_SESSION['WaterTempP3_High_Alarm'] == 3) {
					echo "<td>Acknowledged</td>";
					echo "<td></td>";
					echo "<td></td>";
				}
				if ($_SESSION['WaterTempP3_High_Alarm'] == 4) {
					echo "<td>Acknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td></td>";
				}
				echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Delete\" onclick=\"alarm_sql('WaterTempP3','High_Alarm',0)\" /></td>";
			echo "</tr>";
		}

		if ($_SESSION['WaterTempP4_Low_Alarm'] > 0) {
			echo "<tr>";
				echo "<td>";
				echo $_SESSION['WaterTempP4_Low_Time'];
				echo "</td>";
				echo "<td>WaterTempP4 Low</td>";
				if ($_SESSION['WaterTempP4_Low_Alarm'] == 1) {
					echo "<td>Unacknowledged</td>";
					echo "<td></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP4','Low_Alarm',3)\" /></td>";
				}
				if ($_SESSION['WaterTempP4_Low_Alarm'] == 2) {
					echo "<td>Unacknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP4','Low_Alarm',4)\" /></td>";
				}
				if ($_SESSION['WaterTempP4_Low_Alarm'] == 3) {
					echo "<td>Acknowledged</td>";
					echo "<td></td>";
					echo "<td></td>";
				}
				if ($_SESSION['WaterTempP4_Low_Alarm'] == 4) {
					echo "<td>Acknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td></td>";
				}
				echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Delete\" onclick=\"alarm_sql('WaterTempP4','Low_Alarm',0)\" /></td>";
			echo "</tr>";
		}
		
		if ($_SESSION['WaterTempP4_High_Alarm'] > 0) {
			echo "<tr>";
				echo "<td>";
				echo $_SESSION['WaterTempP4_High_Time'];
				echo "</td>";
				echo "<td>WaterTempP4 High</td>";
				if ($_SESSION['WaterTempP4_High_Alarm'] == 1) {
					echo "<td>Unacknowledged</td>";
					echo "<td></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP4','High_Alarm',3)\" /></td>";
				}
				if ($_SESSION['WaterTempP4_High_Alarm'] == 2) {
					echo "<td>Unacknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Acknowledge\" onclick=\"alarm_sql('WaterTempP4','High_Alarm',4)\" /></td>";
				}
				if ($_SESSION['WaterTempP4_High_Alarm'] == 3) {
					echo "<td>Acknowledged</td>";
					echo "<td></td>";
					echo "<td></td>";
				}
				if ($_SESSION['WaterTempP4_High_Alarm'] == 4) {
					echo "<td>Acknowledged</td>";
					echo "<td align=\"center\"><img src=\"img/email.png\" /></td>";
					echo "<td></td>";
				}
				echo "<td><input type=\"submit\" name=\"alarmname_ack_id\" id=\"alarmname_ack_id\" value=\"Delete\" onclick=\"alarm_sql('WaterTempP4','High_Alarm',0)\" /></td>";
			echo "</tr>";
		}
