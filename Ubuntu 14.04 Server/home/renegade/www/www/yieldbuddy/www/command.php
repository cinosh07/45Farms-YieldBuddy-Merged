...
<p>
	...
	if ($submit == "Save WaterTempP1 Settings"){
	$WaterTempP1Value_Low = $_GET["WaterTempP1Value_Low"];
	$WaterTempP1Value_High = $_GET["WaterTempP1Value_High"];
	$WaterTempP1Heater_ON = $_GET["WaterTempP1Heater_ON"];
	$WaterTempP1Heater_OFF = $_GET["WaterTempP1Heater_OFF"];
	$WaterTempP1AC_ON= $_GET["WaterTempP1AC_ON"];
	$WaterTempP1AC_OFF = $_GET["WaterTempP1AC_OFF"];		
	$command="setWaterTempP1," .$WaterTempP1Value_Low. "," .$WaterTempP1Value_High. "," .$WaterTempP1Heater_ON. "," .$WaterTempP1Heater_OFF. "," .$WaterTempP1AC_ON. "," .$WaterTempP1AC_OFF;
	}	
	
	if ($submit == "Save WaterTempP2 Settings"){
	$WaterTempP2Value_Low = $_GET["WaterTempP2Value_Low"];
	$WaterTempP2Value_High = $_GET["WaterTempP2Value_High"];
	$WaterTempP2Heater_ON = $_GET["WaterTempP2Heater_ON"];
	$WaterTempP2Heater_OFF = $_GET["WaterTempP2Heater_OFF"];
	$WaterTempP2AC_ON= $_GET["WaterTempP2AC_ON"];
	$WaterTempP2AC_OFF = $_GET["WaterTempP2AC_OFF"];		
	$command="setWaterTempP2," .$WaterTempP2Value_Low. "," .$WaterTempP2Value_High. "," .$WaterTempP2Heater_ON. "," .$WaterTempP2Heater_OFF. "," .$WaterTempP2AC_ON. "," .$WaterTempP2AC_OFF;
	}		
	
	if ($submit == "Save WaterTempP3 Settings"){
	$WaterTempP3Value_Low = $_GET["WaterTempP3Value_Low"];
	$WaterTempP3Value_High = $_GET["WaterTempP3Value_High"];
	$WaterTempP3Heater_ON = $_GET["WaterTempP3Heater_ON"];
	$WaterTempP3Heater_OFF = $_GET["WaterTempP3Heater_OFF"];
	$WaterTempP3AC_ON= $_GET["WaterTempP3AC_ON"];
	$WaterTempP3AC_OFF = $_GET["WaterTempP3AC_OFF"];		
	$command="setWaterTempP3," .$WaterTempP3Value_Low. "," .$WaterTempP3Value_High. "," .$WaterTempP3Heater_ON. "," .$WaterTempP3Heater_OFF. "," .$WaterTempP3AC_ON. "," .$WaterTempP3AC_OFF;
	}		
	
	if ($submit == "Save WaterTempP4 Settings"){
	$WaterTempP4Value_Low = $_GET["WaterTempP4Value_Low"];
	$WaterTempP4Value_High = $_GET["WaterTempP4Value_High"];
	$WaterTempP4Heater_ON = $_GET["WaterTempP4Heater_ON"];
	$WaterTempP4Heater_OFF = $_GET["WaterTempP4Heater_OFF"];
	$WaterTempP4AC_ON= $_GET["WaterTempP4AC_ON"];
	$WaterTempP4AC_OFF = $_GET["WaterTempP4AC_OFF"];		
	$command="setWaterTempP4," .$WaterTempP4Value_Low. "," .$WaterTempP4Value_High. "," .$WaterTempP4Heater_ON. "," .$WaterTempP4Heater_OFF. "," .$WaterTempP4AC_ON. "," .$WaterTempP4AC_OFF;
	}		
