...
//include ($_SERVER['DOCUMENT_ROOT'].'/yieldbuddy/www/sql/sql_relays_firstrow.php');
	  ...
	  {
	  echo "<tr>";
	  echo "<td>Relay 2 (Xfer Pump 1): </td>";
	  ...
	  {
      echo "<tr>";
	  echo "<td>Relay 3 (Xfer Pump 2) </td>";
	  ...
	  {
      echo "<tr>";
	  echo "<td>Relay 4 (Xfer Pump 3): </td>";
