...
include 'sql/sql_email_firstrow.php';
...
<p align="center"><span class="description">Filename must be 'firmware.cpp.hex'  Click 'Upload' to upload. Click 'Update' to update.</span></p>
  ...
  <tr>
    ...
    <?php
		...
		$ArduinoTime=$_SESSION['ArduinoTime'];
		...
		$Arduino_min = $_SESSION['Arduino_min'];
		$Arduino_sec = $_SESSION['Arduino_sec'];
    ...
    ?>
     ...
     <table width="775" border="0">     </table>
  </tr>
</table></body>
</html>
