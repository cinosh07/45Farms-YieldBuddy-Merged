...
void RestoreDefaults() {
  ...
  WaterTempP2Value_Low = 40.00;
  WaterTempP2Value_High = 80.00;
    //Accessory ON/OFF Values
  WaterTempP2Heater_ON = 35.00;
  WaterTempP2Heater_OFF = 45.00;
  WaterTempP2AC_ON = 85.00;
  WaterTempP2AC_OFF = 75.00;

  //**WaterTempP3
  WaterTempP3_Status = "OK";
  WaterTempP3Value_Low = 40.00;
  WaterTempP3Value_High = 80.00;
    //Accessory ON/OFF Values
  WaterTempP3Heater_ON = 35.00;
  WaterTempP3Heater_OFF = 45.00;
  WaterTempP3AC_ON = 85.00;
  WaterTempP3AC_OFF = 75.00;

  //**WaterTempP4
  WaterTempP4_Status = "OK";
  WaterTempP4Value_Low = 40.00;
  WaterTempP4Value_High = 80.00;
    //Accessory ON/OFF Values
  WaterTempP4Heater_ON = 35.00;
  WaterTempP4Heater_OFF = 45.00;
  WaterTempP4AC_ON = 85.00;
  WaterTempP4AC_OFF = 75.00;
  ...
  //**WaterTempP1
  eepromWriteFloat(500, WaterTempP1Value_Low);
  eepromWriteFloat(504, WaterTempP1Value_High);
  eepromWriteFloat(508, WaterTempP1Heater_ON);
  eepromWriteFloat(512, WaterTempP1Heater_OFF);
  eepromWriteFloat(516, WaterTempP1AC_ON);
  eepromWriteFloat(520, WaterTempP1AC_OFF);

  //**WaterTempP2
  eepromWriteFloat(524, WaterTempP2Value_Low);
  eepromWriteFloat(528, WaterTempP2Value_High);
  eepromWriteFloat(532, WaterTempP2Heater_ON);
  eepromWriteFloat(536, WaterTempP2Heater_OFF);
  eepromWriteFloat(540, WaterTempP2AC_ON);
  eepromWriteFloat(544, WaterTempP2AC_OFF);

  //**WaterTempP3
  eepromWriteFloat(548, WaterTempP3Value_Low);
  eepromWriteFloat(552, WaterTempP3Value_High);
  ...
  eepromWriteFloat(576, WaterTempP4Value_High);
