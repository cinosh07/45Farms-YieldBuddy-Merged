...
//  pH1Value = (pHSlope * pH1RawValue + pHOffset);
 ...
 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
    ...
    Tank1RawValue = digitalRead(Tank1LimitSwitchPin);
  #else
  ...
  Tank1Value =0;
    ...
    Tank2RawValue = digitalRead(Tank2LimitSwitchPin);
  #else
  ...
  Tank2Value =0;
    ...
    Tank3RawValue = digitalRead(Tank3LimitSwitchPin);
  #else
  ...
  Tank3Value =0;
    ...
    Tank4RawValue = digitalRead(Tank4LimitSwitchPin);
  #else
